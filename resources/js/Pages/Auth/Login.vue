  ...
  <div class="min-h-screen flex items-center justify-center px-4">
    ...
    <div class="w-full max-w-md animate-fade-in">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-indigo-300 mt-1">AI-Powered Note Taking</p>
      </div>
        ...
        <form @submit.prevent="submit" class="space-y-4">
          ...
          <div>
            ...
            <div class="relative">
              <input
                ...
                id="password"
                placeholder="••••••••"
                class="input-field w-full px-4 py-3 rounded-xl text-sm pr-10"
                required
              />
          ...
          <div class="flex items-center gap-2">
            <input type="checkbox" id="remember" v-model="form.remember"
              class="w-4 h-4 rounded border-indigo-500 bg-transparent accent-indigo-500">
            <label for="remember" class="text-sm text-indigo-300">Remember me</label>
          </div>
